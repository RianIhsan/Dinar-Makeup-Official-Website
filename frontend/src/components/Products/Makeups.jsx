  ...
  return (
    <div className="mt-20 mx-4 sm:mx-8 lg:mx-20">
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {data.weddingMakeupPackages.map((pkg, index) => (
            ...
            >
              {pkg.popular && (
                <div className="absolute top-4 right-4 bg-error text-base-100 text-xs font-bold px-3 py-1 rounded-full flex items-center">
              ...
              <div className="p-6 bg-base-100 h-full flex flex-col"> {/* key line: flex-col */}
                ...
                <div className="mb-6">
                  <div className="flex items-center">
                    <span className="text-xl font-semibold text-error">{pkg.price}</span>
                  </div>
                </div>
                ...
                <div className="mt-auto">
                  <button className="btn btn-error w-full hover:shadow-md transition-all">
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {data.regularMakeupPackages.map((pkg, index) => (
            <div
              key={index}
              className={`relative rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl ${pkg.popular ? 'border-2 border-error' : 'border border-gray-200'}`}
            >
              ...
              <div className="p-6 bg-base-10 h-full flex flex-col"> {/* ← added flex-col */}
                ...
                <div className="mb-6 space-y-2">
                  <div className="flex items-center">
                    <FiHome className="text-error mr-2" />
                    <span className="font-medium">By Owner:</span>
                    <span className="text-xl font-semibold text-error ml-2">{pkg.priceOwner}</span>
                  </div>
                  <div className="flex items-center">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-10">
          ...
          <ul className="space-y-3 text-gray-600">
            {data.generalRegularTerms.map((term, i) => (
              <li key={i} className="flex">
                <span className="mr-2">•</span>
                <span>{term}</span>
              </li>
      ...
      {/* Contact Info */}
      <div className="text-center bg-error/10 rounded-xl p-6">
        <h3 className="text-xl font-bold text-gray-900 mb-2">For bookings and inquiries</h3>
        <p className="text-lg text-gray-700 mb-4">Contact us at <a href="tel:0898000845" className="text-error font-semibold">0898-0000-845</a></p>
